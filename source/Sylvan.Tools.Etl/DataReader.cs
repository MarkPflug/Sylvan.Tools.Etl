...
namespace Sylvan.Data.Etl
{
	...
	{
		internal static DbDataReader OpenReader(string filename, bool useSchema = true, Action<double> prog = null)
		{
			...
			{
				case ".csv":
					return OpenCsv(filename, useSchema, prog);
				case ".dbf":
		...
		static DbDataReader OpenCsv(string filename, bool useSchema, Action<double> prog)
		{
